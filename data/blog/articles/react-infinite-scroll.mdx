...
category: blog
thumnailImg: https://velog.velcdn.com/images/otterp/post/126477b1-1924-4fa3-aa47-181563515ab7/image.jpeg
---
...
- `clientHeight`는 일단 100vh라고 생각하고 고정값이다. 현재 개발 과정에서 `clientHieght`는 `821px`이다.
